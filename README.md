...
> [!NOTE]
> **v0.1.4-beta** — macOS·Windows 클라이언트와, Windows 실제 장비 및 Linux 컨테이너에서 검증했습니다.
...
v0.1.4-beta를 만든 환경: Go 1.26.5 · Node 22.13.1 · Wails 2.13.0 · Docker 29.4.0 (macOS 26.5.2 arm64).
