...
> [!NOTE]
> **v0.1.1-beta** — macOS·Windows 클라이언트와, Windows 실제 장비 및 Linux 컨테이너에서 검증했습니다.
...
5. **가볍게** — Electron을 쓰지 않습니다. 바이너리 10MB 미만, 실행까지 1초 이내

## 기능

| | |
|---|---|
| **파일** | 탐색·업로드·다운로드(진행률·취소)·이름 변경·삭제·권한(체크박스 + `chmod 755` 직접 입력)·텍스트 편집 |
