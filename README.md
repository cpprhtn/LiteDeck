...
<p align="center">
  <sub>접속 한 번으로 <b>파일 · 편집기 · 서비스 · 프로세스 · 컨테이너 · 네트워크 · 세션 · 터미널</b>까지.<br>
...
| | |
|---|---|
| **파일** | 트리 탐색·**이름으로 거르기**·업로드·다운로드(진행률·취소·**끊기면 이어받기**)·폴더째 전송·이름 변경·삭제·권한(체크박스 + `chmod 755` 직접 입력) |
...
| **컨테이너** | Docker·Podman 카드. 시작/중지/재시작/삭제·**실시간 로그 보기**·이미지/볼륨 정리. Compose로 띄운 것은 **서비스·프로젝트 단위 재시작** |
