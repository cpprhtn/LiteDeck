...
v1.4.0 was built with Go 1.26.6, Node 22.13.1, Wails CLI 2.13.0 (library 2.14.0), Docker 29.4.0 on macOS 26.5.2 arm64.
The release workflow pins the same CLI. `@latest` above may hand you a newer one; it still builds.
