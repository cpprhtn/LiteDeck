...
v2.1.1을 만든 환경: Go 1.26.6 · Node 22.13.1 · Wails CLI 2.13.0 (라이브러리 2.14.0) · Docker 29.4.0 (macOS 26.6.2 arm64).
릴리스 워크플로도 같은 CLI를 씁니다. 위의 `@latest`로 받으면 더 새 CLI가 올 수 있는데, 그래도 빌드는 됩니다.
