...
> [!NOTE]
> **v0.1.3-beta** — verified on macOS and Windows clients, against a real Windows machine and Linux containers.
...
v0.1.3-beta was built with Go 1.26.5, Node 22.13.1, Wails 2.13.0, Docker 29.4.0 on macOS 26.5.2 arm64.
